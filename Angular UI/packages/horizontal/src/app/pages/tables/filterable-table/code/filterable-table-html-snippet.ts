export const FILTERABLE_TABLE_HTML_SNIPPET = `  <mat-label class="text-sm font-semibold block mb-2 mt-4">Filter</mat-label>
    ...
    <div class="relative overflow-auto mt-7.5">
      <table mat-table [dataSource]="dataSource" class="min-w-full">
        ...
        <tr class="mat-row" *matNoDataRow>
          <td class="mat-cell" colspan="4" class="whitespace-nowrap">
