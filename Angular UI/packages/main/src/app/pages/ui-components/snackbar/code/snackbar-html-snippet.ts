export const BASIC_SNACKBAR_HTML_SNIPPET = `  <div class="grid grid-cols-12 gap-6">
...
export const CUSTOM_COMPONENT_SNACKBAR_HTML_SNIPPET = `  <div class="grid grid-cols-12 gap-6">
          <div class="col-span-12 lg:col-span-4">
            <mat-form-field appearance="outline" class="w-full">
...
export const CONFIGURABLE_SNACKBAR_HTML_SNIPPET = `  <div class="grid grid-cols-12 gap-6">
          <div class="col-span-12 lg:col-span-4">
            <mat-form-field appearance="outline" class="w-full">
