...
export class AppSalesLocationsComponent implements AfterViewInit {
    ...
    constructor(
      ...
      ngAfterViewInit() {
        ...
        this.browserOnly(() => {
          let root = am5.Root.new('sales-locations');
          ...
          // Define data
          let cities = [
            {title: 'Kimberley', latitude: -28.741943, longitude: 24.771944 },
