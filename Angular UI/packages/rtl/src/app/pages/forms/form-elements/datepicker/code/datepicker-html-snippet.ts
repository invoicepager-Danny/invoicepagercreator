export const BASIC_DATEPICKER_HTML_SNIPPET = `  <mat-form-field appearance="outline" class="w-full">
...
export const CUSTOM_SELECTIONS_DATEPICKER_HTML_SNIPPET = `  <mat-form-field appearance="outline" class="w-full">
...
export const FORM_INTEGRATION_DATEPICKER_HTML_SNIPPET = `  <mat-form-field appearance="outline" class="w-full">
              <mat-label>Enter a date range</mat-label>
...
export const ACTION_BUTTONS_DATEPICKER_HTML_SNIPPET = `  <mat-form-field appearance="outline" class="w-full">
              <mat-label>Choose a date</mat-label>
...
export const DATE_RANGE_PICKER_DATEPICKER_HTML_SNIPPET = `  <mat-form-field class="w-full" appearance="outline">
...
export const OPEN_METHOD_DATEPICKER_HTML_SNIPPET = `  <mat-form-field class="w-full" appearance="outline">
              <mat-label>Choose a date</mat-label>
...
export const CUSTOM_ICON_DATEPICKER_HTML_SNIPPET = `  <mat-form-field class="w-full" appearance="outline">
              <mat-label>Choose a date</mat-label>
...
export const CUSTOM_DATE_CLASSES_DATEPICKER_HTML_SNIPPET = `  <mat-form-field class="w-full" appearance="outline">
              <mat-label>Choose a date</mat-label>
...
export const PALLETE_COLORS_DATEPICKER_HTML_SNIPPET = `  <mat-form-field color="accent" appearance="outline" class="w-full">
            ...
            <mat-form-field color="accent" appearance="outline" class="w-full mt-5">
...
export const CHANGE_EVENTS_DATEPICKER_HTML_SNIPPET = `  <mat-form-field class="w-full" appearance="outline">
            ...
            <div class="bg-light rounded-md p-6 mt-4">
              <h2 class="text-base font-semibold mb-4">Logs:</h2>
...
export const START_DATE_DATEPICKER_HTML_SNIPPET = `  <mat-form-field appearance="outline" class="w-full">
              <mat-label>Choose a date</mat-label>
...
export const TOUCH_UI_DATEPICKER_HTML_SNIPPET = `  <mat-form-field class="w-full" appearance="outline">
              <mat-label>Choose a date</mat-label>
