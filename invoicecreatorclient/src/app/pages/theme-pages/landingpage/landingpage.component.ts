...
export class AppLandingpageComponent {
  ...
  testimonials: testimonials[] = [
    ...
    },
    {
      ...
      subtext: 'Features avaibility',
      para: 'I am using the MaterialM angular admin, and its feature rich, easy to use and saves a ton of time. The Support Team is great.'
    },
  ];
  ...
  features: features[] = [
    {
      ...
      subtext:
        'MaterialM Admin comes with 6 pre-defined theme colors.',
    },
    {
      id: 2,
      icon: 'shield-lock',
    ...
    },
    {
      ...
      subtext:
        'The MaterialM Admin Pack includes nearly 50 UI components.',
    },
    {
      id: 5,
      icon: 'tag',
    ...
    },
    {
      ...
      subtext:
        'The MaterialM Admin package includes a wide variety of icon fonts.',
    },
    {
      id: 7,
