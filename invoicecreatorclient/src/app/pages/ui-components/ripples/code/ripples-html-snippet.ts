export const RIPPLES_HTML_SNIPPET = `  <mat-checkbox [(ngModel)]="centered" class="example-ripple-checkbox" color="primary">Centered</mat-checkbox>
    ...
    <div>
      <mat-form-field class="example-ripple-form-field mx-1" appearance="outline">
    ...
    <div class="example-ripple-container cursor-pointer text-center w-[300px] h-[300px] leading-[300px] select-none cardWithShadow" matRipple [matRippleCentered]="centered"
