export const DIALOG_ANIMATION_HTML_SNIPPET = `  <div class="grid grid-cols-12 gap-6">
                <div class="sm:col-span-6 col-span-12">
                  <button mat-flat-button color="primary" (click)="openDialog('0ms', '0ms')" class="w-full">
                    Open Dialog without animation
                  </button>
                </div>
                <div class="sm:col-span-6 col-span-12">
                  <button mat-flat-button color="accent" class="ms-2" (click)="openDialog('3000ms', '1500ms')"
                    class="w-full">
                    Open Dialog slowly
                  </button>
                </div>
              ...
              <!-- dialog view -->
              <h5 mat-dialog-title class="mat-subtitle-1">Delete file</h5>
...
export const DIALOG_SCROLLABLE_HTML_SNIPPET = `  <button mat-flat-button color="primary" (click)="openHeaderDialog()" class="w-full">
              ...
              <mat-dialog-content class="mat-typography">
                <h3 class="text-base font-semibold mt-4">Develop across all platforms</h3>
                <p class="text-sm lh-24">
                ...
                <h3 class="text-base font-semibold mt-4">Speed &amp; Performance</h3>
                <p class="text-sm lh-24">
                ...
                <h3 class="text-base font-semibold mt-4">Incredible tooling</h3>
                <p class="text-sm lh-24">
                ...
                <h3 class="text-base font-semibold mt-4">Loved by millions</h3>
                <p class="text-sm lh-24">
                ...
                <h3 class="text-base font-semibold mt-4">What is Angular?</h3>
                ...
                <h3 class="text-base font-semibold mt-4">Architecture overview</h3>
...
export const DIALOG_INJECTING_HTML_SNIPPET = `  <button mat-flat-button color="accent" (click)="openInjectDialog()" class="w-full">
                Open dialog
              </button>
...
export const DIALOG_MENU_HTML_SNIPPET = `  <button mat-flat-button class="w-full" color="primary" [matMenuTriggerFor]="menu" #menuTrigger>
                Menu
              </button>
...
export const DIALOG_OVERVIEW_HTML_SNIPPET = `  <mat-form-field appearance="outline" class="w-full">
                <mat-label>What's your name?</mat-label>
                <input matInput [(ngModel)]="name" />
              </mat-form-field>
              <button mat-flat-button class="bg-primary w-full" (click)="openDialogEx()">Pick one</button>
              @if (animal()) {
              <span class="mt-3 block">
                You chose: <span class="font-semibold">{{ animal() }}</span>
              </span>
              }
