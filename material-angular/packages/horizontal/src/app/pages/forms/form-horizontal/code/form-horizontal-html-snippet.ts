export const BASIC_LAYOUT_HTML_SNIPPET = `    <form>
          ...
          <div class="grid grid-cols-12 sm:gap-6 justify-end">
            <div class="col-span-12 sm:col-span-8">
...
export const FORM_SEPARATOR_HTML_SNIPPET = `    <mat-card>
          <mat-card-content>
            <h4 class="text-base font-semibold mb-4">Account Details</h4>
          ...
          <mat-card-content class="border-t border-border">
            <h4 class="text-base font-semibold mb-4">Personal Info</h4>
            <div class="grid grid-cols-12 sm:gap-6">
              <div class="col-span-12 sm:col-span-4 flex items-center">
                <mat-label class="text-sm font-semibold block mb-2"
                  >Full Name
...
export const FORM_LABEL_ALIGN_HTML_SNIPPET = `    <mat-card>
          <mat-card-content>
            ...
            <div class="grid grid-cols-12 sm:gap-6">
              <div
                class="col-span-12 sm:col-span-4 flex items-center justify-end"
              >
                <mat-label class="text-sm font-semibold block mb-2"
                  >Username
                </mat-label>
...
export const COLLAPSE_FORM_HTML_SNIPPET = `    <mat-accordion>
      ...
      >
        ...
        <div class="grid grid-cols-12 sm:gap-6 mt-3">
