export const MENU_BASIC_HTML_SNIPPET = `  <button mat-flat-button color="primary" class="mt-2" [matMenuTriggerFor]="menu">
              Menu
            </button>
...
export const MENU_ICONS_HTML_SNIPPET = `  <button mat-icon-button [matMenuTriggerFor]="menu" aria-label="Example icon-button with a menu">
                <mat-icon>
                  <i-tabler name="dots" class="size-5!"></i-tabler>
                </mat-icon>
              </button>
              <mat-menu #menu="matMenu" class="cardWithShadow">
...
export const MENU_NESTED_HTML_SNIPPET = `  <button mat-flat-button color="primary" [matMenuTriggerFor]="animals" class="mt-2">
                Animal index
              </button>
...
export const MENU_POSITIONS_HTML_SNIPPET = `  <div class="grid grid-cols-12 gap-6">
                <div class="sm:col-span-3 col-span-1">
                  <button mat-flat-button color="primary" class="w-full" [matMenuTriggerFor]="aboveMenu">
                    Above
                  </button>
                ...
                <div class="sm:col-span-3 col-span-1">
                  <button mat-flat-button color="accent" class="w-full" [matMenuTriggerFor]="belowMenu">
                    Below
                  </button>
                ...
                <div class="sm:col-span-3 col-span-1">
                  <button mat-flat-button color="warn" class="w-full" [matMenuTriggerFor]="beforeMenu">
                    Before
                  </button>
                ...
                <div class="sm:col-span-3 col-span-1">
                  <button mat-flat-button color="primary" class="w-full" [matMenuTriggerFor]="afterMenu">
                    After
                  </button>
